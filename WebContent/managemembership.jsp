		...
		<div id="mainbody">
			...
			<div id="dashboardpanel">
				...
				<form action="MembershipManager" method="POST">
					...
					<br />
					New Membership Price: <input type="number" name="price" placeholder="Membership Price" value="${memPrice}" required> / Month
					<br /><br />
					<input type="submit" name="editPrice" value="Submit">
				</form>
			</div>
		</div>
